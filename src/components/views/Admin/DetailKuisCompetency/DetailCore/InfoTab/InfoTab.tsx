...
const InfoTab = (props: PropTypes) => {
  ...
  useEffect(() => {
    setValueUpdateInfo("question", `${dataCore?.question}`);
    setValueUpdateInfo("option1", `${dataCore?.option1}`);
    setValueUpdateInfo("option2", `${dataCore?.option2}`);
    setValueUpdateInfo("option3", `${dataCore?.option3}`);
    setValueUpdateInfo("option4", `${dataCore?.option4}`);
    setValueUpdateInfo("optionValid", `${dataCore?.optionValid}`);
  }, [dataCore]);
  ...
  return (
    <Card className="w-full p-4 lg:w-1/2">
      ...
      <CardBody>
        ...
        >
          <Skeleton isLoaded={!!dataCore?.question} className="rounded-lg">
            <Controller
                name="question"
