...
interface PropTypes {
  dataFunctional: IKuisCompetency;
...
const InfoTab = (props: PropTypes) => {
  ...
  useEffect(() => {
    setValueUpdateInfo("question", `${dataFunctional?.question}`);
    setValueUpdateInfo("option1", `${dataFunctional?.option1}`);
    setValueUpdateInfo("option2", `${dataFunctional?.option2}`);
    setValueUpdateInfo("option3", `${dataFunctional?.option3}`);
    setValueUpdateInfo("option4", `${dataFunctional?.option4}`);
    setValueUpdateInfo("optionValid", `${dataFunctional?.optionValid}`);
  }, [dataFunctional]);
  ...
  return (
    <Card className="w-full p-4 lg:w-1/2">
      ...
      <CardBody>
        ...
        >
          <Skeleton isLoaded={!!dataFunctional?.question} className="rounded-lg">
            <Controller
                name="question"
          ...
          <Skeleton
            isLoaded={!!dataFunctional?.option1}
          ...
          <Skeleton
            isLoaded={!!dataFunctional?.option2}
            className="rounded-lg"
          >
            <Controller
                name="option2"
          ...
          <Skeleton
            isLoaded={!!dataFunctional?.option3}
            className="rounded-lg"
          >
            <Controller
                name="option3"
          ...
          <Skeleton
            isLoaded={!!dataFunctional?.option4}
            className="rounded-lg"
          >
            <Controller
                name="option4"
          ...
          <Skeleton
            isLoaded={!!dataFunctional?.optionValid}
            className="rounded-lg"
            >
              <Controller
                name="optionValid"
