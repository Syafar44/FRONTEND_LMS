...
const AddFunctionalModal = (props: PropTypes) => {
  const { isOpen, onClose, onOpenChange, refetchFunctional, competencyId } = props;
  const {
    control,
    errors,
    handleSubmitForm,
  ...
  } = useAddFunctionalModal(competencyId);
  ...
  const disabledSubmit = isPendingMutateAddFunctional
