        ...
        <div className="grid gap-5 mx-auto max-w-[800px] md:p-5">
            <section className="grid gap-5">
                <div className="grid gap-5">
                    ...
                    {!isPendingKajian && (
                        <>
                            <h1 className="font-bold text-2xl">{dataKajian?.title}</h1>
                            <p>{dataKajian?.description}</p>
                        </>
                    )}
                ...
                <div className="flex justify-end">
                    <Button isDisabled={isPendingScore || isPendingKajian || timeDone} onPress={() => router.push(`/kajian-online/kuis/start/${id}?number=1`)} className="bg-accent text-primary">Mulai</Button>
                </div>
            </section>
            <section className="grid gap-5">
                <h2>
